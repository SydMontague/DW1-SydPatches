...
extern "C"
{
    ...
    struct FishingMapData
    {
        ...
        char* spriteFilePath;
        Position* seadramonWaypoints;
        int32_t field16_0x34;
    };

    struct TMDFileLoadingData
    {
        uint32_t objCount; /* Created by retype action */
        uint8_t* bufferEnd;
        uint8_t* field2_0x8;
        uint8_t* targetBuffer; /* Created by retype action */
    };
    ...
    struct FishingData
    {
        ...
        uint32_t mapId; /* Created by retype action */
    ...
    extern dtl::array<FishingMapData, 2> FISHING_MAP_DATA;

    void FISH_loadFishing(FishingRod* rodData);
    void FISH_deinitialize();
    void FISH_init();
    uint32_t FISH_tamerTick();
}