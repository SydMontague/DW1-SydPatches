...
mips-g++ AtlasFont.cpp BuffModel.cpp ThrownItem.cpp Main.cpp BattleEndBox.cpp Timestamp.cpp Helper.cpp Movie.cpp Script.cpp Pause.cpp Tournament.cpp FixedNumbers.cpp Fade.cpp -o ../compiled/Cave5.lib $FLAGS
