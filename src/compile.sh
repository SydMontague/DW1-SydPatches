...
mips-g++ Map.cpp Model.cpp Inventory.cpp ItemEffects.cpp ItemFunctions.cpp EFE.cpp GUI.cpp GameMenu.cpp PlayerMenu.cpp DigimonMenu.cpp StatsView.cpp TechView.cpp PlayerInfoView.cpp PlayerChartView.cpp PlayerMedalView.cpp PlayerCardView.cpp DigimonSprite.cpp -o ../compiled/Cave2.lib $FLAGS
mips-g++ Sound.cpp Math.cpp Camera.cpp Battle.cpp Tournament.cpp -o ../compiled/Cave3.lib $FLAGS
