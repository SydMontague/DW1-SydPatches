...
mips-g++ Timestamp.cpp FixedNumbers.cpp InventoryUI.cpp DOOA/DOOA.cpp CombatCommon.cpp Inventory.cpp Sound.cpp Math.cpp Camera.cpp Battle.cpp Tournament.cpp DigimonData.cpp Transformation.cpp -o ../compiled/Cave3.lib $FLAGS
