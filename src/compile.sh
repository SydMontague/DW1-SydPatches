...
mips-g++ Fade.cpp Main.cpp GameObjects.cpp NPCEntity.cpp GUI.cpp GameMenu.cpp PlayerMenu.cpp DigimonMenu.cpp StatsView.cpp TechView.cpp PlayerInfoView.cpp -o ../compiled/Cave2.lib $FLAGS
